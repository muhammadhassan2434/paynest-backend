...
class ShedulePaymentController extends Controller
{
    ...
    {
        $schedulePayment = PaymentSchedule::where('account_id', $request->account_id)->where('status', 'scheduled')->latest()->get();
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'consumer_number'      => 'nullable',
            'receiver_name'        => 'nullable',
            'amount'               => 'required|min:1',
            'receiver_account_no'  => 'nullable',
