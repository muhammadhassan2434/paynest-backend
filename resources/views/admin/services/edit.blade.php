                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Service Name" name="name" 
                                                   class="form-control" value="{{ old('name', $service->name) }}">
                                            @error('name')
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            @if ($service->logo)
                                                <img src="{{ asset($service->logo) }}" width="100px" class="mt-2">
                                            @endif
                                            @error('logo')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control">
                                                ...
                                                <option value="block" {{ $service->status == 'block' ? 'selected' : '' }}>Block</option>
                                            </select>
                                            @error('status')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
